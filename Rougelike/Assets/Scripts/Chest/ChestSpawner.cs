...
public class ChestSpawner : MonoBehaviour
{
    ...
    private void OnValidate()
    {
        ...
        HelperUtilities.ValidateCheckPositiveValue(this, nameof(chestSpawnChanceMin), chestSpawnChanceMin, true);
        HelperUtilities.ValidateCheckPositiveValue(this, nameof(chestSpawnChanceMax), chestSpawnChanceMax, true);
