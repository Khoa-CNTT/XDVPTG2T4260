...
public class AStarTest : MonoBehaviour
{
    ...
    private void StaticEventHandler_OnRoomChanged(RoomChangedEventArgs roomChangedEventArgs)
    {
        ...
        frontTilemap = instantiatedRoom.transform.Find("Grid/Tilemap_Front").GetComponent<Tilemap>();
    ...
    {
        Transform tilemapCloneTransform = instantiatedRoom.transform.Find("Grid/Tilemap_Front(Clone)");
        ...
        {
            pathTilemap = instantiatedRoom.transform.Find("Grid/Tilemap_Front(Clone)").GetComponent<Tilemap>();
