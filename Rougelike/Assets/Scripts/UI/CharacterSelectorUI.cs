...
public class CharacterSelectorUI : MonoBehaviour
{
    ...
    private bool HasPreviousCharacter()
    {
    ...
    {
        return selectedPlayerIndex < playerDetailsList.Count - 1;
    }
    private void UpdateArrowVisibility()
    {
        previousButton.SetActive(HasPreviousCharacter());
        nextButton.SetActive(HasNextCharacter());
    }
